...
) else ( if "%lAnswer%" == "2" ( set "G_STATE=S_CPP_RUN_CPP_PATH" & set "G_CPP_ID=%lAnswer%" 
)))))
goto :GCpp_Main
::===============================================
...
) else ( if not "%lAnswer%" == "" ( set "G_STATE=S_CPP_RUN_CPP_NAME" & set "G_CPP_PATH=%lAnswer%" 
))))
goto :GCpp_Main
::===============================================
:GCpp_CPP_RUN_CPP_NAME
set "lAnswer=" 
set /p lAnswer=G_CPP_NAME (%G_CPP_NAME%) ? : 
if "%lAnswer%" == "" ( set "lAnswer=%G_CPP_NAME%" )
if "%lAnswer%" == "-q" ( set "G_STATE=S_END"
...
) else ( if not "%lAnswer%" == "" ( set "G_STATE=S_CPP_RUN" & set "G_CPP_NAME=%lAnswer%" 
))))
goto :GCpp_Main
::===============================================
:GCpp_CPP_RUN
